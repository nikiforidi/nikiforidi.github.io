...
| --------------------------------------------------------- | ------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| [National CA Monitoring](national-ca-monitoring/)         | GOST-verified CA certificate pipeline (MinTsifry) | [Deep Dive](/deep-dives/national-ca-monitoring/)                                         |
...
| [JWT Security & Secret Storage](secure-secret-storage/)   | Secure secret storage strategies for CLI tools    | [vpnm](https://github.com/nikiforidi/vpnm)                                               |
