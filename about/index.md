...
| Page                                     | Description                         |
| ---------------------------------------- | ----------------------------------- |
| [Engineering Philosophy](philosophy/)    | Core principles and beliefs         |
| [Career Timeline](timeline/)             | Detailed chronology with milestones |
| [Professional Communities](communities/) | PyPI, GitHub, Habr profiles         |
| [Manifesto](manifesto/en/)               | Personal philosophy                 |
